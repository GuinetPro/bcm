<div class="col-xs-6 col-md-4">
      ...
      <div class="form-group" ng-class="{ 'has-error' : formDireccion.region.$invalid && submitted }">
          ...
          <select  type="text" id="tipo_vivienda" name="tipo_vivienda" class="form-control" ng-model="tipo_vivienda">          
              <option value=""></option>
      ...
      <div class="form-group"  ng-class="{ 'has-error' : formDireccion.calle.$invalid && formDireccion.numero.$invalid &&  submitted}">
          <label for="interior">Tipo Direccion</label>
          ...
          <table class="table">
              <tr>
                ...
                <td>
                    <input type="number" class="form-control" placeholder ="Block" ng-model="block">
                </td>
              </tr>
          </table>
      ...
      <div class="form-group">
          ...
          <input id="sector" class="form-control"  ng-model="sector" type="text" placeholder="">
      </div>
